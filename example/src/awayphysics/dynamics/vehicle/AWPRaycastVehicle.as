package awayphysics.dynamics.vehicle {
	...
	public class AWPRaycastVehicle extends AWPBase {
		...
		public function addWheel(_skin : Away3dObject, connectionPointCS0 : Vector3D, wheelDirectionCS0 : Vector3D, wheelAxleCS : Vector3D, suspensionRestLength : Number, wheelRadius : Number, tuning : AWPVehicleTuning, isFrontWheel : Boolean) : void {
