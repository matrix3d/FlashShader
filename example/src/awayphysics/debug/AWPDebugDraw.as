package awayphysics.debug 
{
	...
	public class AWPDebugDraw 
	{
		...
		private var _segmentSet:Object;
		
		private var m_debugMode:int;
		
		public function AWPDebugDraw(view:Object, physicsWorld:AWPDynamicsWorld)
		{
			_segmentSet = {}
		...
		private function drawTriangles(geometry:Object, scale:Vector3D, transform:AWPTransform, color:uint):void {
