package awayphysics.collision.dispatch {
	...
	public class AWPCollisionObject extends AWPBase implements IEventDispatcher {
		...
		private var m_skin : Away3dObject;
		...
		public function AWPCollisionObject(shape : AWPCollisionShape, skin : Away3dObject, ptr : uint = 0) {
			m_shape = shape;
			m_skin = skin;
		...
		public function get skin() : Away3dObject {
			return m_skin;
		}
		
		public function set skin(value:Away3dObject):void {
			m_skin = value;
			//_originScale.setTo(m_skin.scaleX, m_skin.scaleY, m_skin.scaleZ);
		}
